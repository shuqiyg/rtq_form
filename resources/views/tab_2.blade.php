    ...
    <div class="row">
        <div class="col-md-12">
            ...
            @if ($formVal == 'ownerOccupied')
                <div class="form-group">
                    <label class="col-md-4" style="float: left;"> <span class="nestedBox"> Is this a
                            Corporation? </span><span class="err">*</span> </label>
                    ...
                    <div class="radio_group required">
                        <input type="radio" id="yes" name="insured_isCorporation" value="Yes"><span
                            class="radio_title">Yes</span><input type="radio" id="no" name="insured_isCorporation"
            ...
            <div class="form-group">
                <label class="col-md-4" style="float: left;"> Contact First Name <span
                        class="err">*</span> </label>
                <input type="text" id="insured_contact_first_name" name="insured_contact_first_name"
                    class="form-control col-md-8 required" value="">
            </div>
            <div class="form-group">
                <label class="col-md-4" style="float: left;"> Contact Last Name <span
                        class="err">*</span> </label>
            ...
            <div class="form-group">
                ...
                <input type="email" id="insured_contact_email" name="insured_contact_email"
                    class="form-control col-md-8 checkEmail" value="">
            </div>
            <div class="form-group">
            ...
            @if ($formVal == 'ownerOccupied')
                <div class="form-group">
                    <label class="col-md-4" style="float: left;">Is there a co-occupant that requires coverage?
                        <span class="err">*</span></label>
                    <input type="text" id="insured_coOccupantCoverage" name="insured_coOccupantCoverage"
                        class="form-control col-md-8 required" value="">
                </div>
            @endif
        </div>
