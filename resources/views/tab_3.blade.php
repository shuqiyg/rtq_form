...
<section class="risk_address">
    <div class="row">
        <div class="form-group col-md-12" style="padding-left: 0px;">
            ...
            <input type="checkbox" class="form-control col-md-1" name="sameAsMailingAddress" id="sameAsMailingAddress"
                style="float: left;">
            <label class="col-md-6" style="padding-top: 5px;" for="sameAsMailingAddress"> Same as mailing address
            </label>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <label class="col-md-4" style="float: left;"> Postal code <span class="err">*</span>
                </label>
            ...
            @if ($formVal != 'plumbing')
                <div class="form-group">
                    <label class="col-md-4" style="float: left;"> Lot Size <span class="err">*</span>
                    </label>
                    <select class="form-control col-md-8 required" id="risk_address_lot_size"
                        name="risk_address_lot_size">
                ...
                <div class="form-group" id="describeOver1Acre" style="display: none;">
                    <label class="col-md-4" style="float: left;"><span class="optionalBox"> Describe Use Over 1
                            Acre </span> </label>
                    <input type="text" id="risk_address_describeOver1Acre" name="risk_address_describeOver1Acre"
            ...
            @if ($formVal == 'plumbing')
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="col-md-4" style="float: left;"> Is building coverage required? <span
            ...
            <div class="form-group howManyMortgageesBox">
                <label class="col-md-4" style="float: left;"> How Many Mortgagees ? <span
                        class="err">*</span> </label>
                <select class="form-control col-md-8 required" id="risk_address_howmany_mortgagees"
                    name="risk_address_howmany_mortgagees">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="col-md-4" style="float: left;"> Has the insured been cancelled/declined
            ...
            <div class="form-group" id="risk_address_hasInsuredCancelInsuranceIfYesBox" style="display: none;">
                <label class="col-md-4" style="float: left;"> <span class="optionalBox">If yes, please attach
                        details </span> </label>
                <input type="text" id="risk_address_hasInsuredCancelInsuranceIfYes"
                    name="risk_address_hasInsuredCancelInsuranceIfYes" class="form-control col-md-8" value="">
            </div>
            ...
            @if ($formVal != 'plumbing')
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="col-md-4" style="float: left;"> Number of claims in the last 5 years?
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="col-md-4" style="float: left;"> Are you aware of any incidence that may
                                result in a claim?</label>
                            ...
                            <div class="radio_group">
                                <input type="radio" id="yes" name="risk_address_incidenceInClaim" value="Yes"><span
                                    class="radio_title">Yes</span><input type="radio" id="no"
                                    name="risk_address_incidenceInClaim" value="No"><span
                                    class="radio_title">No</span>
                ...
                <div id="incidenceOfClaimBox" style="display: none;">
                    <div class="form-group">
                        <label class="col-md-4" style="float: left;"> <span class="optionalBox">If yes, please
                                advise details </span> </label>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control col-md-8 required" id="risk_address_incidenceOfClaim_type"
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="col-md-4" style="float: left;"> In what type of neighborhood is it
                                located ? <span class="err">*</span></label>
                            <select class="form-control col-md-8 required" id="risk_address_typeOfNeighborhood"
                                name="risk_address_typeOfNeighborhood">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" id="buildingConstruction_surroundingExposureNorth"
                        name="buildingConstruction_surroundingExposureNorth" class="form-control col-md-8" value="">
                </div>

                <div class="form-group">
                    <label class="col-md-4" style="float: left;">South</label>
                    <input type="text" id="buildingConstruction_surroundingExposureSouth"
                        name="buildingConstruction_surroundingExposureSouth" class="form-control col-md-8" value="">
                </div>

                <div class="form-group">
                    <label class="col-md-4" style="float: left;">East</label>
                    <input type="text" id="buildingConstruction_surroundingExposureEast"
                        name="buildingConstruction_surroundingExposureEast" class="form-control col-md-8" value="">
                </div>

                <div class="form-group">
                    <label class="col-md-4" style="float: left;">West</label>
                    <input type="text" id="buildingConstruction_surroundingExposureWest"
                        name="buildingConstruction_surroundingExposureWest" class="form-control col-md-8" value="">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" id="buildingConstruction_OccupancyByOther"
                        name="buildingConstruction_OccupancyByOther" class="form-control col-md-8" value=""
                        placeholder="Leave empty if no Occupancy">
                </div>
            </div>
        </div>
    </section>
