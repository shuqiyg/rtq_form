    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <select id="fireAlarmDetectors_smokeHeatDetectors" name="fireAlarmDetectors_smokeHeatDetectors"
            ...
            <div class="form-group">
                ...
                <select id="fireAlarmDetectors_sprinklers" name="fireAlarmDetectors_sprinklers"
                    class="form-control col-md-8">
            ...
            <div class="form-group" id="sprinklersCoverageBox" style="display: none;">
                <label class="col-md-4" style="float: left;"><span class="nestedBox">Sprinkler
                        Coverage</span></label>
                <select id="fireAlarmDetectors_sprinklerCoverage" name="fireAlarmDetectors_sprinklerCoverage"
                    class="form-control col-md-8">
            ...
            <div class="form-group" id="sprinklersCoveragePartialBox" style="display: none;">
                <label class="col-md-4" style="float: left;"><span class="nested2Box">Sprinkler Coverage
                        Percentage</span></label>
                <input type="number" id="fireAlarmDetectors_sprinklerCoveragePer"
                    name="fireAlarmDetectors_sprinklerCoveragePer" class="form-control col-md-8"
            ...
            @if ($formVal == 'plumbing')
                <div class="form-group">
                    ...
                    <div class="radio_group">
                        <input type="radio" id="yes" name="fireAlarmDetectors_pullBox" value="Yes"><span
                            class="radio_title">Yes</span><input type="radio" id="no"
                            name="fireAlarmDetectors_pullBox" value="No"><span class="radio_title">No</span>
                    </div>
                </div>
            @endif

            <div class="form-group">
                <label class="col-md-4" style="float: left;"> Hydrant(s) <span
                        class="err">*</span></label>
                <select id="fireAlarmDetectors_hydrant" name="fireAlarmDetectors_hydrant"
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="col-md-4" style="float: left;"> Fire Department - Distance <span
                                class="err">*</span></label>
                        <select id="fireAlarmDetectors_fireDeptDistance" name="fireAlarmDetectors_fireDeptDistance"
                            class="form-control col-md-8 required">
            ...
            <div class="form-group">
                <label class="col-md-4" style="float: left;"> Fire Department - Type <span
                        class="err">*</span></label>
            ...
            @if ($formVal == 'plumbing')
                <div class="form-group">
                    <label class="col-md-4" style="float: left;"> Inhouse Portable Extinguisher/s <span
                            class="err"> *</span></label>
                    ...
                    <div class="radio_group required">
                        <input type="radio" id="yes" name="fireAlarmDetectors_inhousePortableExtinguishers"
                            value="Yes"><span class="radio_title">Yes</span><input type="radio" id="no"
                            name="fireAlarmDetectors_inhousePortableExtinguishers" value="No"><span
...
@if ($formVal == 'plumbing')
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="burglaryAlarm_makeOfAlarm" name="burglaryAlarm_makeOfAlarm"
                        class="form-control col-md-8" value="">
                </div>

                <div class="form-group">
                    <label class="col-md-4" style="float: left;"> Monitoring Company </label>
                    <input type="text" id="burglaryAlarm_monitoringCompany" name="burglaryAlarm_monitoringCompany"
                        class="form-control col-md-8" value="">
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="radio_group">
                        <input type="radio" id="yes" name="burglaryAlarm_safe" value="Yes"><span
                            class="radio_title">Yes</span><input type="radio" id="no" name="burglaryAlarm_safe"
                ...
                <div class="form-group burglaryAlarm_safeBox" style="display: none;">
                    ...
                    <input type="text" id="burglaryAlarm_safeClass" name="burglaryAlarm_safeClass"
                        class="form-control col-md-8 " value="">
                </div>
                <!-- <div class="form-group burglaryAlarm_safeBox" style="display: none;">
                ...
                <div class="form-group">
                    ...
                    <div class="radio_group">
                        <input type="radio" id="yes" name="burglaryAlarm_otherMeasures_barsOnWindows" value="Yes"><span
                            class="radio_title">Yes</span><input type="radio" id="no"
                            name="burglaryAlarm_otherMeasures_barsOnWindows" value="No"><span
                            class="radio_title">No</span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="radio_group">
                        <input type="radio" id="yes" name="burglaryAlarm_otherMeasures_deadboltOnDoors"
                            value="Yes"><span class="radio_title">Yes</span><input type="radio" id="no"
                            name="burglaryAlarm_otherMeasures_deadboltOnDoors" value="No"><span
                            class="radio_title">No</span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="radio_group">
                        <input type="radio" id="yes" name="burglaryAlarm_otherMeasures_perimeterLighting"
                            value="Yes"><span class="radio_title">Yes</span><input type="radio" id="no"
                            name="burglaryAlarm_otherMeasures_perimeterLighting" value="No"><span
                            class="radio_title">No</span>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-4" style="float: left;"> Guard Dog <span
                            class="err">*</span></label>
 ...
 -->
                    <div class="radio_group required">
                        <input type="radio" id="yes" name="burglaryAlarm_otherMeasures_guardDog" value="Yes"><span
                            class="radio_title">Yes</span><input type="radio" id="no"
                            name="burglaryAlarm_otherMeasures_guardDog" value="No"><span
                            class="radio_title">No</span>
                        <span class="radio_error" style="display:none;color: red;">Required.</span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" id="burglaryAlarm_otherMeasures_other" name="burglaryAlarm_otherMeasures_other"
                        class="form-control col-md-8" value="">
                </div>
