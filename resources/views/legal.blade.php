...
<section class="legalTerms">
 ...
 -->
    ...
    <div class="row">
        <div class="col-md-12">
            <input type="checkbox" class="form-control col-md-1" id="cb1" style="float: left;"><span
                class="col-md-11"><label for="cb1">I acknowledge that I am a representative of the Brokerage used
                    for this
    ...
    <div class="row">
        <div class="col-md-12">
            <input type="checkbox" class="form-control col-md-1" id="cb2" style="float: left;"><span
                class="col-md-11"><label for="cb2">I acknowledge that I am licensed in the province where the Risk
                    is located</label></span>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <input type="checkbox" class="form-control col-md-1" id="cb3" style="float: left;"><span
                class="col-md-11"><label for="cb3">I acknowledge that I have read and understood the information
                    contained on this
                    page</label></span>
        </div>
    </div>
    <h3 class="legalHeader"> Purpose of this Form </h3>
    <p>This application can provide an actual quote that can be bound by the Broker’s Representative. Certain conditions
        must be met: </p>
    <ul>
        ...
        <li>The system may determine that some feature(s) of the risk require Underwriter intervention in order to
            produce a quote. In that case:
            <ul>
    ...
    <p>Although Binding is initiated by the Broker through this form, it is not considered Bound until the
        representative receives a confirmation email directly from AMFUM. This confirmation will contain:</p>
    <ul>
        ...
        @if ($formVal == 'homeInspector')
            <li>If this submission includes Errors & Omissions Coverage:
                <ul>
                    <li>Errors and Omissions insurance that applies on a claims-made basis. The following provides a
                        general description of this coverage and is subject to the terms and provisions of the actual
                        policy.</li>
                </ul>
            </li>
        @endif
    </ul>
    <p>Please note that completion of the on-line application does not eliminate the requirement for a signed
        application. Once the application is received, it is to be signed by your client and sent to us within five (5)
        days after coverage is bound.</p>
    <h3 class="legalHeader">Supplemental Documentation Required:</h3>
    <p>Please note we reserve the right to request additional information about any risk bound through this portal upon
        review of the information received.</p>
    <p>In consideration of the limit of Business Interruption coverage being requested, we may also will require the
        following:</p>
    <p>If the requested Business Interruption Limit is over $ 100,000 (but not over $ 250,000): A copy of a
        satisfactorily completed Business Interruption Worksheet is required within five days of binding.</p>
    <p>If the requested business Interruption limit is over $ 250,000: A copy of the insured`s most recent financial
        statements is required within 10 days of binding.</p>
    <p>As is the case with quotes based on the traditional printed applications, our electronic quotation is made with
        reliance on the information contained in the electronic application.</p>
    ...
    <p>A copy of our company privacy policy is located here: <a href="https://www.amfredericks.com/privacy-policy"
            target="_blank">https://www.amfredericks.com/privacy-policy</a></p>
    <p>Additionally, as it pertains to this application, no information is stored online and is transmitted securely to
        our internal system. AMFUM has no control over the Broker’s systems and assume all standard security protocols
        are followed by the Broker.</p>
