    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group has-feedback">
                <label class="col-md-4" style="float: left;"> Broker Name <span class="err">*</span>
                </label>
            ...
            <div class="form-group has-feedback">
                ...
                <input type="text" id="broker_code" name="broker_code"
                    class="form-control col-md-8 onlyNumbers validateBroker" value="" maxlength="4">
            </div>
            <div class="form-group has-feedback">
                <label class="col-md-4" style="float: left;"> Producer Name <span class="err">*</span>
                </label>
                <input type="text" id="broker_producer_name" name="broker_producer_name"
            ...
            <div class="form-group has-feedback">
                ...
                <label class="col-md-4" style="float: left;"> Producer Email <span class="err">*</span>
                </label>
                <input type="email" id="broker_producer_email" name="broker_producer_email"
                    class="form-control col-md-8 checkEmail validateBroker required" value="">
            </div>
            <div class="form-group has-feedback">
                <p class="validPhoneError" style="display: none;color: red;">Please enter valid phone</p>
                <label class="col-md-4" style="float: left;"> Producer Phone <span class="err">*</span>
                </label>
                <input type="tel" id="broker_producer_phone" name="broker_producer_phone"
                    class="form-control col-md-8 checkPhone required" value=""
            ...
            @if ($formVal == 'plumbing' || $formVal == 'dayCare')
                <div class="form-group">
                    ...
                    <input type="text" id="due_date" name="due_date" class="form-control col-md-8 datepicker " value=""
...
<section class="brokerSurvey">
    ...
    <div class="row">
        <div class="form-group col-md-12 item_flex">
            <label class="col-md-4"> Do you know the Applicant Personally <span class="err">*</span>
            </label>
            ...
            <div class="radio_group required">
                <input type="radio" id="yes" name="brokerSurvey_applicantPersonally" value="Yes"><span
                    class="radio_title">Yes</span><input type="radio" id="no" name="brokerSurvey_applicantPersonally"
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group" id="ifYesApplicantPersonally" style="display: none;">
                <label class="col-md-4" style="float: left;"><span class="optionalBox">If Yes, for how long
                    </span> </label>
                <input type="tel" id="brokerSurvey_applicantPersonally_HowLong"
                    name="brokerSurvey_applicantPersonally_HowLong" class="form-control col-md-8">
            </div>
