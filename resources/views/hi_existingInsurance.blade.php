    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <label><input type="radio" id="yes" name="existingInsurance_currentlyInsured" value="Yes"><span class="radio_title">Yes</span></label><label><input type="radio" id="no" name="existingInsurance_currentlyInsured" value="No"><span class="radio_title">No</span></label>
            ...
            <div class="form-group eiBOX" style="display: none;">
                <label class="col-md-4" style="float: left;"> Expiry Date <span class="err">*</span> </label>
            ...
            <div class="form-group eiBOX" style="display: none;">
                <label class="col-md-4" style="float: left;"> Retroactive Date <span class="err">*</span> </label>
                <input type="text" id="risk_address_existingInsurerRetroactiveDate" name="risk_address_existingInsurerRetroactiveDate" class="form-control col-md-8 datepicker"  value="" placeholder="mm/dd/yyyy">
            </div>
            ...
            <div class="form-group eiBOX" style="display: none;">
                ...
                <textarea rows="5" id="existingInsurance_termsAndConditions" name="existingInsurance_termsAndConditions" class="form-control col-md-8"></textarea>
            </div>
